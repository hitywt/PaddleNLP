...
class MPNetTrainer(Trainer):
    ...
    def evaluation_loop(
        ...
        elif isinstance(dataloader, paddle.base.dataloader.dataloader_iter._DataLoaderIterBase):
        ...
        if max_eval_iters > 0:
            ...
            if isinstance(dataloader, paddle.base.dataloader.dataloader_iter._DataLoaderIterBase) and isinstance(
